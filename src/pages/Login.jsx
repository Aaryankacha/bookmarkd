...
const Login = () => {
  ...
  const handleGoogleSignIn = () => {
    // UI placeholder for social sign-in integration
    setError('Google Sign-In is currently in demo mode. Please log in with your account credentials.');
  };
  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-[#FAF8F5]/90 border border-black/10 rounded-2xl pl-12 pr-4 py-3.5 text-[#1D1D1F] placeholder:text-[#AAAAAA] text-sm focus:outline-none focus:ring-2 focus:ring-[#D4A65A]/40 focus:border-[#D4A65A] focus:bg-white transition-all shadow-sm"
              value={email}
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <button 
              ...
              className="text-xs text-[#D4A65A] font-medium hover:underline hover:text-[#C29549] transition-colors"
            >
              Forgot Password?
            </button>
          </div>
          <div className="relative">
            ...
            <input 
              ...
              required
              placeholder="••••••••"
              className="w-full bg-[#FAF8F5]/90 border border-black/10 rounded-2xl pl-12 pr-12 py-3.5 text-[#1D1D1F] placeholder:text-[#AAAAAA] text-sm focus:outline-none focus:ring-2 focus:ring-[#D4A65A]/40 focus:border-[#D4A65A] focus:bg-white transition-all shadow-sm"
              value={password}
      ...
      {/* BOTTOM LINK */}
      <p className="mt-8 text-center text-sm text-[#666666] font-sans">
        Don&apos;t have an account?{' '}
        <Link to="/register" className="text-[#D4A65A] font-semibold hover:underline hover:text-[#C29549] transition-colors">
          Create one
        </Link>
      </p>
    </AuthLayout>
